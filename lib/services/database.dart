...
class DatabaseServices{
  ...
  //collection service
final CollectionReference hotelCollection = Firestore.instance.collection('hotels');
...
Stream<List<Hotel>> get hotels{
  return hotelCollection.snapshots()
...
Stream<UserData> get userData{
  return hotelCollection.document(uid).snapshots()
